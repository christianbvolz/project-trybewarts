...
1. Clone o repositório
  * `git clone git@github.com:betrybe/sd-014-a-project-trybewarts.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-014-a-project-trybewarts`
...
4. Crie na raiz do projeto os arquivos que você precisará desenvolver:
  * Verifique que você está na raiz do projeto
    * Exemplo: `pwd` -> o retorno vai ser algo como _/Users/joao/code/**sd-014-a-project-trybewarts**_
...
7. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-014-a-project-trybewarts/pulls)
...
* Adicione uma descrição para o _Pull Request_ no seguinte formato: `[Joao Silva e Maria Souza] Trybewarts`, e clique no botão verde _"Create pull request"_
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-014-a-project-trybewarts/pulls) e confira que o seu _Pull Request_ está criado
